<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateQuantity.aspx.cs" Inherits="PharmacyWebApplication.IncreaseQuantity" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label id ="empLabel" runat="server" Text=" Employee " ></asp:Label>
            ...
            <asp:Label id ="ActionLabel" runat="server" Text=" Action Type " ></asp:Label>
            
            <asp:DropDownList id="DropDownListActionTypes" runat="server" DataTextField = "name" DataValueField = "ID"  OnSelectedIndexChanged="Selection_ChangeType"  AutoPostBack="true">
